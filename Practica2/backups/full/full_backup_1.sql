...
CREATE TABLE `LOG_ACTIVIDAD` (
  ...
  KEY `fk_log_actividad_paciente` (`PACIENTE_idPaciente`),
  KEY `fk_habitacion_log_actividad` (`HABITACION_idHabitacion`),
...
CREATE TABLE `LOG_HABITACION` (
  ...
  `statusx` varchar(15) DEFAULT NULL,
  `idHabitacion` int DEFAULT NULL,
  PRIMARY KEY (`timestampx`),
  KEY `fk_habitacion_log_habitacion` (`idHabitacion`),
...
-- Dump completed on 2023-09-18  3:33:01
